    ...
    <br />
		<uib-tabset type="pills">
		    <uib-tab heading="Active Tasks">
		    	...
		    	<div class="row text-center" ng-hide="anyActiveUsuarios">
		    		<div class="col-md-12">
		    	...
		    	<div class="col-lg-offset-1" ng-show="anyActiveUsuarios">
			    		...
			    		<li>
				    		<div class="row">
				    			<div class="col-md-4">
				    				...
				    				<span ng-class="{'task-crossout': list.IsDone}"> {{list.nome}} </span>
				    			</div>
			    			</div>
			    		</li>
			    	</ul>
		    ...
		    <uib-tab heading="Completed Tasks">
		    	...
		    	<div class="col-lg-offset-1">
			    	<ul ng-repeat="list in completedUsuarios" style="list-style-type: none;">
			    		<li>
				    		<div class="row">
				    			<div class="col-md-4">
				    				<span ng-class="{'task-crossout': list.IsDone}"> {{list.nome}} </span>
		    ...
		    <uib-tab heading="Show all Tasks">
		    	<h3>All tasks</h3>
		    	<div class="col-lg-offset-1">
			    	<ul ng-repeat="list in allUsuarios" style="list-style-type: none;">
			    		<li>
				    		<div class="row">
				    			<div class="col-md-4">
